    ...
    <header className="p-4 dark:bg-gray-100 dark:text-gray-800">
      <div className="container flex justify-between items-center h-16 mx-auto relative">
        ...
        <div className="hidden lg:flex items-center">
          <Link to={"/auth/login"}>
            <button className="self-center px-4 py-2 rounded">Login</button>
          </Link>
          <button className="self-center px-4 py-2 uppercase font-semibold rounded dark:bg-violet-600 dark:text-gray-50">
            Book Now
          </button>
        </div>
